...
import type { IPackage, Logger, PackageJson } from "@fluid-tools/build-infrastructure";
 ...
 */
function getTypeTestFilePath(pkg: IPackage, outDir: string, outFile: string): string {
	return path.join(
		pkg.directory,
		outDir,
