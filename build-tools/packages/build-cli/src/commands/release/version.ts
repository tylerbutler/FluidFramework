...
import { BaseCommand, MonoRepoKind, sortVersions } from "../../library/index.js";
...
/**
 * The `release version` command is used to update the versions of packages in a workspace.
 *
 * This command is used in CI to determine release information when a new release tag is pushed.
 */
export default class ReleaseVersionCommand extends BaseCommand<typeof ReleaseVersionCommand> {
	static readonly summary = "Versions packages according to any pending changesets.";
