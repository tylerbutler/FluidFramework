`flub releaseDeprecated`
========================

Releases a package or release group.

* [`flub releaseDeprecated`](#flub-releasedeprecated)
...
```
USAGE
  $ flub releaseDeprecated [-v | --quiet] [-g client|server|azure|build-tools|gitrest|historian | -p <value>] [-t
...
_See code: [src/commands/releaseDeprecated.ts](https://github.com/microsoft/FluidFramework/blob/main/build-tools/packages/build-cli/src/commands/releaseDeprecated.ts)_
