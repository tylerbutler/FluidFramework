...
* [`flubx check postbuild`](#flubx-check-postbuild)
...
_See code: [@fluid-tools/build-cli](https://github.com/microsoft/FluidFramework/blob/main/build-tools/packages/build-cli/src/commands/check/policy.ts)_

## `flubx check postbuild`

```
USAGE
  $ flubx check postbuild [-v | --quiet] [--concurrency <value>] [--all | --dir <value> | --packages | -g
...
_See code: [src/commands/check/postbuild.ts](https://github.com/microsoft/FluidFramework/blob/main/build-tools/packages/build-cli-esm/src/commands/check/postbuild.ts)_
