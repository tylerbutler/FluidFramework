...
export class ModificationContext extends BaseContext {
	 ...
	 */
	constructor(
		in_nestedChangeSet: SerializedChangeSet,
	...
	_getPropertyElement() {
		if (this._propertyHint) {
			...
			return this._baseDataBinding.getPropertyElementForTokenizedPath(
				this._relativeTokenizedPath,
				!this._boundToRef,
			);
		} else {
