# @fluid-internal/sorted-btree

Fork of https://github.com/qwertie/btree-typescript with changes to make it work with target `es2020`, and `node/node16`
module resolution (with corresponding `esnext/node16` module setting).
